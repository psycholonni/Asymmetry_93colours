...
let expName = 'Asymmetry_93colours';  // from the Builder filename that created this script
...
function colourcodesRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of colourcodesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function stimpositionsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of stimpositionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Stim2_display_pracRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Stim2_display_pracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LoopCounterRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of LoopCounterComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Stim2_displayRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Stim2_displayComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
